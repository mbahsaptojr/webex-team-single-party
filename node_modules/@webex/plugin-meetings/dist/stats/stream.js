  ...
  var timer = (0, _commonTimers.safeSetTimeout)(function () {
    ...
    if (pc) {
      pc.getStats().then(function (stats) {
        ...
        if (!(pc.signalingState === _constants._CLOSED_ || pc.connectionState === _constants._CLOSED_)) {
          schedule(emitter);
        }
      }).catch(function (err) {
        emitter.emit(_constants._ERROR_, err);
      });
    }
  }, _constants.DEFAULT_STATS_INTERVAL);
...
var StatsStream = function (_Readable) {
  ...
  function StatsStream(pc) {
    ...
    emitter.once(_constants._ERROR_, function (err) {
      _this.emit(_constants._ERROR_, err);
    });
    return _this;
  }
  ...
  (0, _createClass3.default)(StatsStream, [{
    ...
    value: function _read() {
      ...
      emitter.once(_constants._DATA_, function (data) {
        if (!_this2.isPaused()) {
          _this2.push(data);
        }
      });
