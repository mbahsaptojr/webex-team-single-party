...
exports.config = exports.ServerErrorInterceptor = exports.DeviceUrlInterceptor = exports.UrlInterceptor = exports.EmbargoInterceptor = exports.ServiceModel = exports.ServiceCollection = exports.FeatureModel = exports.FeatureCollection = exports.FeaturesModel = exports.Device = exports.default = undefined;
...
var _serverError = require('./interceptors/server-error');

Object.defineProperty(exports, 'ServerErrorInterceptor', {
  enumerable: true,
  get: function get() {
...
(0, _sparkCore.registerInternalPlugin)('device', _device2.default, {
  interceptors: {
    ...
    ServerErrorInterceptor: _serverError2.default.create
  },
